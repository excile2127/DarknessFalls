...
public class PlayerDashing : PlayerAction
{
    ...
    // Reference to the hitbox responder for double dashing
    [SerializeField] public HitboxResponder doubleDashAttack;

    // Accessor for whether the player is double dashing
    public bool DoubleDashing
    {
        get { return _dashState == DashState.DoubleDashing; }
    }
            ...
            switch (_dashState)
            {
                ...
                case DashState.Dashing: case DashState.DashCooldown:
                    if (!_actionController.DeathsDoor)
                    {
                        ...
                        // Set the hurtbox to inactive
                        _hurtbox.active = false;
                        // Call double dash attack
                        doubleDashAttack.Attack();
        ...
        switch (_dashState)
        {
            ...
            case DashState.DoubleDashing:
                ...
                if (_dashTimer >= dashDuration || !_actionController.Grounded)
                {
                    ...
                    // Set the hurtbox to active
                    _hurtbox.active = true;
                    // Stop the double dash attack
                    doubleDashAttack.StopAttack();
